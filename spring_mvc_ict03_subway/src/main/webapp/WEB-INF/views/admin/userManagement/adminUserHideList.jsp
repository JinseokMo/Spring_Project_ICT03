...
<body>
    ...
    <div class="col-md-10 container-fluid">
	    ...
	    <table class="table table-hover" style = "text-align :center; vertical-align : middle;">
	    	...
	    	<c:forEach var="hideList" items="${hideList}">
	    	<tr>
	    		<td>${hideList.userNo}</td>
	    		<td>${hideList.userEmail}</td>
	    		<td>${hideList.userNickname}</td>
	    		<td>${hideList.lastName} ${hideList.firstName}</td>
	    		<td>${hideList.userBirth}</td>
	    		<td>${hideList.userCountry}</td>
	    		<td>${hideList.userHP}</td>
	    		<td>
