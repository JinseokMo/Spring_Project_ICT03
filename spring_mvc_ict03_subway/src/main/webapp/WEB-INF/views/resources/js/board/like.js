...
boardLike.addEventListener("click", e => {
    ...
    if(e.target.classList.contains("bi bi-balloon-heart")){ // 좋아요 체크 X (빈하트)
        check = 0;
    } else{ // 좋아요 체크 O (꽉찬하트)
        check = 1;
    }
    ...
    .then(count => {
        ...
        e.target.classList.toggle("bi bi-balloon-heart");
        e.target.classList.toggle("bi bi-balloon-heart-fill");
