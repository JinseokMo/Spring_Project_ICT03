            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <div class="">
                    <div class="dropdown dropdown">
                        <a href="${path}/logoutAction.us" class="btn btn-light">LogOut</a>
                        <a class="btn btn-light ms-2 dropdown-toggle " data-bs-toggle = "dropdown" type="button"><i class="fa-solid fa-user"></i></a>
                        <ul class="dropdown-menu">
                            <a class="dropdown-item" href="${path}/myInfo.us">My Info</a>
                            <li><hr class="dropdown-divider"></li>
                            <a class="dropdown-item" href="${path}/board_add.bc">Write a new post</a>
                        </ul>    
                    </div>
                </div>
            </div>
