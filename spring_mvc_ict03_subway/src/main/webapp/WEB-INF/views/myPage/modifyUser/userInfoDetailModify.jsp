	...
	<div class = "row d-flex align-items-stretch">
		...
		<!-- 본문시작 div -->
			...
			<div class = "w-75 mb-3 row">
				<form action="userProfileUpdate.us?userNo=${sessionScope.userDTO.userNo}" method="POST" enctype="multipart/form-data" class="row">
			...
			<form class ="w-75 text-center border" method="POST" name="adminUserInfo" action="userInfoModifyAction.us">
				<div class="mt-3 mb-3 row">							   		
			 	...
			 	<div class="mb-3 row">
			   		...
			   		<div class="col-md-2">
			    		<input type="text" class="form-control text-center" id="lastName" name="lastName" value="${sessionScope.userDTO.lastName}">
			   		</div>
			   		<label for="userName" class="col-md-3 col-form-label">FistName</label>
			   		<div class="col-md-2">
			    		<input type="text" class="form-control text-center" id=fistName name="fistName" value="${sessionScope.userDTO.firstName}">
			   		</div>
			 	</div>
			 	...
			 	<div class="mb-3 row">
			   		...
			   		<div class="col-md-6">
			    		<input type="text" class="form-control text-center col-md-1" id="userNickname" name="userNickname" value="${sessionScope.userDTO.userNickname}">
			   		</div>
			   		<input class = "btn btn-outline-dark col-md-1" type="button" name="userNinknameCheck" value="Check" onclick="confirmNickname()">
			 	</div>
			 	
			 	<div class="mb-3 row">
			   		<label for="userBirth" class="col-md-3 col-form-label">BirthDay</label>
			   		<div class="col-md-7">
			    		<input type="text" class="form-control text-center" id="userBirth" name="userBirth" value="${sessionScope.userDTO.userBirth}">
			   		</div>
			 	</div>
			 	...
			 	<div class="mb-3 row">
			   		...
			   		<div class="col-md-7">
			    		<input type="text" class="form-control text-center" id="userCountry" name="userCountry" value="${sessionScope.userDTO.userCountry}">
			   		</div>
			 	</div>
